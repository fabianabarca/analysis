...
- The Django project is in `/home/bucr/analysis`
- The virtual environment is in `/home/bucr/analysis/analysisenv/bin`
...
CELERY_BIN="/home/bucr/analysis/analysisenv/bin/celery"
